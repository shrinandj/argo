...
def add_platform_only_flags(parser):
    ...
    parser.add_argument("--bucket-endpoint", default=None, required=True, help="HTTP Endpoint for the cluster-bucket")
    parser.add_argument("--access-key", default=None, required=True, help="Access key for accessing the bucket")
    parser.add_argument("--secret-key", default=None, required=True, help="Secret key for accessing the bucket")
